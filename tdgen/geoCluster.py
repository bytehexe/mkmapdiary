...
class GeoCluster:
    def __init__(self, locations):
        ...
        self.__degrees, self.__distance, self.__midpoint = self.__longest_greatcircle_separation()
    ...
    def zoom_level(self):
        ...
        level = int(round(np.log2(360. / self.__degrees * adjustment_factor)))
    ...
    def __longest_greatcircle_separation(self):
        ...
        central_angle = np.arccos(np.clip(
